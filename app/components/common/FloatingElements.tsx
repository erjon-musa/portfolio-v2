...
const items: { text: string, type: 'tech' | 'project' | 'interest' }[] = [
  ...
  { text: "Computer Vision", type: "tech" },
  { text: "CUDA", type: "tech" },
  { text: "Python", type: "tech" },

  { text: "MyEyes AI", type: "project" },
  { text: "YOLOv8", type: "project" },
  { text: "CLIP", type: "project" },
  { text: "SnoutNet", type: "project" },

  { text: "Deep Learning", type: "interest" },
  { text: "Embedded AI", type: "interest" },
  { text: "Queen's University", type: "interest" },
]
    ...
    >
      {elements.map((item) => (
        <motion.div
          ...
          className={`
            absolute font-mono
            ${item.type === 'tech' && 'text-cyan-400/60 text-base sm:text-lg'}
            ${item.type === 'project' && 'text-blue-400/60 text-lg sm:text-xl font-bold'}
            ${item.type === 'interest' && 'text-sky-400/60 text-sm'}
          `}
